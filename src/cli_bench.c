...
static void usage(void) {
    fprintf(stderr,
        ...
        "  --prefill-max-burst-ms M  cap how long ONE prefill command buffer may\n"
        "                        hold the GPU; splits the layer sweep when it\n"
        "                        overruns (0/unset = disabled). Keep well under\n"
        "                        80000: past that macOS watchdog-kills WindowServer\n"
